...
% Last Modified by GUIDE v2.5 16-Jul-2022 20:57:34
...
'PlotBoxAspectRatio',[1 0.511794871794872 0.511794871794872],...
...
'Position',[-0.428571428571429 2.27777777777778 139.285714285714 27.7222222222222],...
'InnerPosition',[-0.428571428571429 2.27777777777778 139.285714285714 27.7222222222222],...
...
'Color',[0 0 0],...
'ColorMode','auto',...
'Position',[0.500000474880903 1.00551102204409 0.500000000000007],...
'PositionMode','auto',...
'Interpreter','tex',...
...
'Color',[1 1 1],...
'ColorMode','auto',...
'Position',[0.500000476837158 -0.0133600534402138 7.105427357601e-15],...
'PositionMode','auto',...
'Interpreter','tex',...
'InterpreterMode','auto',...
'Rotation',0,...
...
'Color',[1 1 1],...
'ColorMode','auto',...
'Position',[-0.00683760683760684 0.500000476837158 7.105427357601e-15],...
'PositionMode','auto',...
'Interpreter','tex',...
'InterpreterMode','auto',...
'Rotation',90,...
...
'AmbientLightSourceMode',get(0,'defaultaxesAmbientLightSourceMode'),...
'Position',[-0.00102774922918808 -0.00124843945068664 1 0.048689138576779],...
'InnerPosition',[-0.00102774922918808 -0.00124843945068664 1 0.048689138576779],...
'ActivePositionProperty','position',...
'ActivePositionPropertyMode',get(0,'defaultaxesActivePositionPropertyMode'),...
'PositionConstraint','innerposition',...
...
'Color',[1 1 1],...
'ColorMode','auto',...
'Position',[0.500000476837158 -0.0683760683760684 0],...
'PositionMode','auto',...
'Interpreter','tex',...
'InterpreterMode','auto',...
'Rotation',0,...
...
'Tag','uipanel1',...
'Position',[-0.00102040816326531 0.673228346456693 1 0.263779527559055],...
'Layout',[],...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
...
'Style','edit',...
'Position',[0.64020618556701 0.688524590163934 0.336082474226804 0.213114754098361],...
...
'String','songpath: ',...
'Style','text',...
'Position',[0.510309278350516 0.688524590163934 0.116494845360825 0.191256830601093],...
'Children',[],...
...
'String','1.36425648',...
'Style','edit',...
'Position',[0.641237113402062 0.404371584699454 0.337113402061856 0.213114754098361],...
'BackgroundColor',[1 1 1],...
...
'String','beat: ',...
'Style','text',...
'Position',[0.510309278350516 0.420765027322404 0.116494845360825 0.191256830601093],...
'Children',[],...
'ForegroundColor',[0.301960784313725 0.745098039215686 0.933333333333333],...
'ButtonDownFcn',blanks(0),...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
...
'Position',[0.254639175257732 0.092896174863388 0.0958762886597938 0.207650273224044],...
...
'String','play',...
'Style',get(0,'defaultuicontrolStyle'),...
'Position',[0.765979381443299 0.092896174863388 0.0958762886597938 0.207650273224044],...
'BackgroundColor',[0.650980392156863 0.650980392156863 0.650980392156863],...
...
'String','0.2',...
'Style','edit',...
'Position',[0.141542183883863 0.413265306122449 0.341547443719756 0.214285714285714],...
'BackgroundColor',[1 1 1],...
...
'String','piece: ',...
'Style','text',...
'Position',[0.00923101199242584 0.423469387755102 0.116926151904061 0.188775510204082],...
'Children',[],...
...
'Units','normalized',...
'FontUnits',get(0,'defaultuicontrolFontUnits'),...
'String','../resource/piano.wav',...
'Style','edit',...
'Position',[0.140516515884704 0.688775510204082 0.342573111718914 0.214285714285714],...
'BackgroundColor',[1 1 1],...
...
'String','wavpath: ',...
'Style','text',...
'Position',[0.00923101199242584 0.693877551020408 0.116926151904061 0.188775510204082],...
'Children',[],...
'ForegroundColor',[0.494117647058824 0.184313725490196 0.556862745098039],...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
'Tag','s1',...
...
'Title',blanks(0),...
'Tag','uipanel3',...
'Position',[-0.00102040816326531 0.931758530183727 1 0.0669291338582677],...
'Layout',[],...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
...
'Style','text',...
'Position',[0.371282051282051 0.239130434782609 0.29948717948718 0.826086956521739],...
'Children',[],...
